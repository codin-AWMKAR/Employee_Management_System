...
const AcceptTask = ({data}) => {
  ...
  return (
    <div className='flex-shrink-0 h-full w-[300px] p-5 bg-yellow-400 rounded-xl flex flex-col'>
  ...
  <div className='flex justify-between mt-auto'> {/* Ensure buttons stick to the bottom */}
